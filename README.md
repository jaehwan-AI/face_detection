...
![alt tag](xception.PNG){: width="50%" height="50%"}

## Sample Outputs

sample image:

![alt tag](sample/sample1.jpg){: width="50%" height="50%"}

sample video:

![alt tag](sample/sample2.gif){: width="50%" height="50%"}

sample webcam:

![alt tag](sample/sample3.gif){: width="50%" height="50%"}
